...
corrupted = corrupted.slice(0, 2920);
...
// manually binary search through potential answers
// find last wall added when cost of 70,70 becomes Infinity (not visitable)
// see line 17, where we i manually check numbers between 0 and 3450 (length of input)
// 2000 -> 3450 -> 2500 -> 2900 -> 2950 -> 2925 -> 2915 -> 2918 -> 2920
console.log(costs);
console.log(corrupted.at(-1));
